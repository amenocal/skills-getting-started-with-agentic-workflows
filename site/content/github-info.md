...
- **GitHub Copilot now supports agent mode**: GitHub Copilot can now autonomously perform multi-step tasks, helping developers build features, fix bugs, and run terminal commands directly within VS Code.
